...
def test_binary_insertion_sort_unsorted_with_duplicates():
...
def test_binary_insertion_sort_floats():
    collection = [3.14, 1.41, 2.72, 0.58]
    res = binary_insertion_sort(collection)
    assert res == [pytest.approx(0.58), pytest.approx(1.41), pytest.approx(2.72), pytest.approx(3.14)]
    assert res is collection
